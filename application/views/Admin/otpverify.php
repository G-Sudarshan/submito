...
<head>
    ...
    <title>OTP verification | Admin Password</title>
    <!-- Bootstrap Link -->
...
<body class="hm-gradient">
      ...
      <div class="container" align="center">
        ...
        ?>
        <p> OTP has been sent to your Email Address : <?= $this->session->userdata('email'); ?> OTP is valid for 4 minutes </p><br/>
        <?php  echo form_open('Email/verify_otp') ?>
          <div class="text-center sm-4">
            <h1 class="h3 sm-3 font-weight-normal">Enter your OTP to verify</h1><br/>
          </div>
          <div class="col-lg-4">
          ...
          <button class="btn btn-lg btn-primary btn-block" type="submit">Verify OTP</button><br/>
